...
from run_on_pdbs import run_on_pdbs_folder, run_combfold
...
def merge_exi_and_full_seq_into_subunit_info(experimental: Dict[str, str], full_seq: Dict[str, str]) -> Tuple[
    SubunitsInfo, SubunitsInfo]:
    """
...
def cf_exi_only(output_path:str, pdb_path:str, af_output_path:str, exi_subunits_path:str):
    ...
    result_path = os.path.join(output_path, 'cf_only_exi')
